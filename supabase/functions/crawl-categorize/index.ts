...
const TAXONOMY = [
  ...
  { key:'leadership',      label:'Leadership & Staff',   group:'identity',  inventory_kind:'fact_rich',  url_patterns:[/^\/(staff|team|leadership|elders|pastors|our-team)\/?/i,/^\/(staff|team)\//i], item_fields:['name','role','bio','photo_url','email'], description:'Staff + leadership.' },

...
const TAXONOMY = [
  ...
  { key:'leadership',      label:'Leadership & Staff',   group:'identity',  inventory_kind:'fact_rich',
    url_patterns:[/^\/(staff|team|leadership|leader|leaders|elders|eldership|pastor|pastors|senior-pastor|lead-pastor|head-pastor|our-team|our-leaders|our-pastors|our-staff|meet-our-team|meet-the-staff|meet-the-team|meet-the-pastors|meet-our-pastors|meet-our-elders|meet-our-leaders|deacons|deacon-team|bio[a-z]+|about-our-pastor[a-z]*|about-our-staff)(?:\/|$)/i],
    priority_url_patterns:[/^\/(staff|team|leadership|leader|leaders|elders|eldership|pastor|pastors|senior-pastor|lead-pastor|head-pastor|our-team|our-leaders|our-pastors|our-staff|meet-our-team|meet-the-staff|meet-the-team|meet-the-pastors|meet-our-pastors|meet-our-elders|meet-our-leaders|deacons|deacon-team|bio[a-z]+|about-our-pastor[a-z]*|about-our-staff)(?:\/|$)/i],
...
async function llmExtractPage(apiKey, page, urlHits) {
  ...
  const userPrompt = [
    ...
    "8a. HOLIDAY / SEASONAL SERVICES ARE NOT ONGOING EVENTS — a Christmas Eve service page, a Good Friday service page, or an Easter service page (URLs like /christmas, /christmas-eve, /good-friday, /easter, /thanksgiving, or event names containing those words) describes a ONE-DAY-A-YEAR gathering, not an ongoing event on the church's calendar. When the events topic's page is thin AND the site has a separate Christmas/Easter/Good Friday landing page that dominates, DO NOT let those seasonal services overshadow the ongoing events list. Include them if the events / calendar page explicitly lists them alongside real recurring events; OMIT them if they're only appearing because the seasonal landing page was crawled and there's no genuine events calendar. Prefer emitting an EMPTY events topic over an events topic full of holiday services when the church clearly hasn't populated its calendar page.",
    "8b. STAFF / LEADERSHIP FROM ANY BIO PAGE — if a crawled page is a single-person bio (URL like /pastor, /senior-pastor, /lead-pastor, /pastor-<name>, /<name>, or the page's H1 is a person's name followed by their role — e.g. 'John Smith · Lead Pastor'), emit it under the LEADERSHIP topic as items[kind=staff] with name/role/bio populated. Don't drop the bio because the URL doesn't literally contain 'staff' or 'team' — the URL pattern buckets the page, but if you're already reading a clearly-person-bio page under 'other', promote it into leadership yourself. Even a small church with one pastor should have a 1-item leadership topic, not an empty one.",

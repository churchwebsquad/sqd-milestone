# Copywriter Brief — /connect (Connect)
...
After Sonnet outputs the prose, invoke `/format-page` and paste `connect-formatter-inputs.md` to produce the Brixies JSON. Then say "review the page" with the JSON output to get the reviewer's verdict.
...
```json
{
  ...
  "keywords": {
    "primary": [
      "Get connected Riverwood Chapel",
      "Find community Kent Ohio church",
      "Be known Riverwood"
    ],
    "secondary": [
      "Life groups Kent Ohio",
      "Volunteer Riverwood Chapel",
      "Connection group Kent OH",
      "Riverwood pathways",
      "Welcome Center Riverwood"
    ],
    "long_tail": [
      "How to get involved at Riverwood Chapel",
      "First step after visiting Riverwood"
    ],
    "local": [
      "Christian community Kent Ohio"
    ]
  }
}
```
...
[
  {
    ...
    "section_job": "Make every visitor — kid, college student, adult, longtime member — see one path on this page that's clearly theirs",
    "tagline_strategy": "informational",
    "intent_summary": "Connect hero. Tone-aware for primary persona (The Suburban Family).",
  ...
  },
  {
    ...
    "section_job": "Give each life stage one card so a visitor instantly sees their family's next move without having to figure it out",
  ...
  },
  {
    ...
    "section_job": "For the visitor still uncertain which pathway fits, hand them a real person who can hear it out and point the right way",
    "tagline_strategy": null,
...
[
  {
    "atom_external_ref_id": "contentsnare:staff-volunteers-testimonies:volunteers:rfld_baLy9qF2RRODL9",
    "page_slug": "/connect",
    "section_sort_order": null,
    "role": "canonical",
    "treatment": "Full content on /connect."
  },
  {
    "atom_external_ref_id": "contentsnare:staff-volunteers-testimonies:volunteers:rfld_J0KwyaUz11r2dk",
    "page_slug": "/connect",
    "section_sort_order": null,
    "role": "canonical",
    "treatment": "Full content on /connect."
  ...
  {
    "atom_external_ref_id": "contentsnare:staff-volunteers-testimonies:volunteers:rfld_wVd0y3UAJJ1VgZ",
    "page_slug": "/connect",
    "section_sort_order": null,
    "role": "canonical",
    "treatment": "Full content on /connect."
  ...
  {
    "atom_external_ref_id": "discovery:messaging.key_phrases.1",
    "page_slug": "/connect",
    "section_sort_order": null,
    "role": "reference",
    "treatment": "Voice ammo: lift verbatim in Be Known framing."
  }
]
```
...
[
  {
    "external_ref_id": "contentsnare:staff-volunteers-testimonies:volunteers:rfld_wVd0y3UAJJ1VgZ",
    "topic": "volunteer_note",
    "label": "Any additional notes about volunteer opportunities:",
    "body": "Sign Up Form - https://riverwoodchapel.churchcenter.com/people/forms/990923",
    "body_short": null,
    "verbatim": true,
  ...
  {
    "external_ref_id": "contentsnare:staff-volunteers-testimonies:volunteers:rfld_J0KwyaUz11r2dk",
    "topic": "volunteer_vocabulary",
    "label": "What language does your church typically use when talking about volunteering?",
    "body": "Serving, being missional, being known,",
    "body_short": null,
    "verbatim": true,
    "content_quality": "clean",
    "source_kind": "content_collection",
  ...
  {
    "external_ref_id": "contentsnare:staff-volunteers-testimonies:volunteers:rfld_baLy9qF2RRODL9",
    "topic": "volunteer_motivation",
    "label": "Why should someone apply to volunteer at your church?",
    "body": "Volunteering at Riverwood isn’t just about filling a spot on a team—it’s about joining God’s work in our church and community. When you serve, you get the joy of helping others know Jesus, building meaningful relationships, and making Riverwood a welcoming place for every person who walks through the doors.\n\nWe believe God gifts each person uniquely, and volunteering is one of the best ways to use those gifts. Whether it’s greeting at the door, making coffee, leading kids, serving students, or running tech, every role matters and helps people experience the love of Christ.\n\nVolunteering also connects you more deeply to the Riverwood family. You’ll grow in community, find purpose in serving others, and know that what you’re doing has an eternal impact.",
    "body_short": null,
    "verbatim": true,
    "content_quality": "clean",
    "source_kind": "content_collection",
  ...
  {
    "external_ref_id": "discovery:messaging.key_phrases.1",
    "topic": "voice_ammo",
    "label": null,
    "body": "being known",
    "body_short": null,

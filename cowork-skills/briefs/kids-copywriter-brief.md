# Copywriter Brief — /kids (Kids at Riverwood)
...
After Sonnet outputs the prose, invoke `/format-page` and paste `kids-formatter-inputs.md` to produce the Brixies JSON. Then say "review the page" with the JSON output to get the reviewer's verdict.

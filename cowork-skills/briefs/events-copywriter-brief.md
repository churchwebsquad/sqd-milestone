# Copywriter Brief — /events (Events)
...
After Sonnet outputs the prose, invoke `/format-page` and paste `events-formatter-inputs.md` to produce the Brixies JSON. Then say "review the page" with the JSON output to get the reviewer's verdict.
...
[
  {
    ...
    "intent_summary": "Events hero. Tone-aware for primary persona (All four).",
...
```json
{
  ...
  "archive_filter.tagline": 60,
  "archive_filter.heading": 100,
  "archive_filter.description": 400,

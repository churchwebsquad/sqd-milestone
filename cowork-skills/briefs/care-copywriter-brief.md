# Copywriter Brief — /care (Care & Recovery)
...
After Sonnet outputs the prose, invoke `/format-page` and paste `care-formatter-inputs.md` to produce the Brixies JSON. Then say "review the page" with the JSON output to get the reviewer's verdict.
...
```json
{
  ...
  "keywords": {
    "primary": [
      "Celebrate Recovery Kent Ohio",
      "GriefShare Kent OH",
      "Care ministry Kent church"
    ],
    "secondary": [
      "Overcome group Riverwood",
      "Cancer care ministry Kent",
      "Crisis support Kent Ohio church",
      "Recovery group Portage County",
      "Biblical counseling Kent"
    ],
    "long_tail": [
      "Is there a church in Kent with a recovery program",
      "Where can I find GriefShare in Kent Ohio",
      "Cancer care support Kent Ohio"
    ],
    "local": [
      "Support groups Kent Ohio church",
      "Portage County care ministry"
    ]
  }
}
```
...
[
  {
    ...
    "section_job": "Tell a person walking through a hard season that they don't have to be okay to come here, and that someone in this church has walked through it too",
    "tagline_strategy": "informational",
    "intent_summary": "Care & Recovery hero. Tone-aware for primary persona (The Person in a Hard Season).",
  ...
  },
  {
    ...
    "section_job": "Let a person in a specific hard season see a card that names exactly what they're going through, so they know they're not the first one to need it here",
    "tagline_strategy": null,
    "intent_summary": "5 named programs as cards: Care 101, GriefShare, Overcome, Celebrate Recovery, Cancer Care.",
    "atom_external_ref_ids": [
      "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_0",
      "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_1",
      "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_2",
      "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_3",
      "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_4"
    ],
    "concept_upgrade_recommended": null,
    "proof_person": null,
    "emotional_weight_no_proof_note": null
  },
  {
    ...
    "section_job": "Give a person who's hurting a real name, a real email, and the sense that a human being is already on the other side waiting for their message",
    "tagline_strategy": null,
...
[
  {
    "atom_external_ref_id": "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_0",
    "page_slug": "/care",
    "section_sort_order": 2,
    "role": "canonical",
    "treatment": "Full content on /care. Section 2."
  },
  {
    "atom_external_ref_id": "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_1",
    "page_slug": "/care",
    "section_sort_order": 2,
    "role": "canonical",
    "treatment": "Full content on /care. Section 2."
  ...
  {
    "atom_external_ref_id": "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_2",
    "page_slug": "/care",
    "section_sort_order": 2,
    "role": "canonical",
    "treatment": "Full content on /care. Section 2."
  ...
  {
    "atom_external_ref_id": "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_3",
    "page_slug": "/care",
    "section_sort_order": 2,
    "role": "canonical",
    "treatment": "Full content on /care. Section 2."
  ...
  {
    "atom_external_ref_id": "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_4",
    "page_slug": "/care",
    "section_sort_order": 2,
    "role": "canonical",
    "treatment": "Full content on /care. Section 2."
...
[
  {
    "external_ref_id": "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_3",
    "topic": "care_ministry",
    "label": null,
    "body": "Celebrate RecoveryMondays 6:30pm in The Gathering SpaceLeader: Kirk McCutcheonIs Celebrate Recovery for me or someone I know?Life's hurts affect everyone no matter their stage of life.&nbsp; You do not need to struggle alone.&nbsp; No matter the struggle or hurt you are facing, CR is a safe and confidential place to find healing and freedom!&nbsp;What to Expect?6:30 Large GroupWorshipLesson or Testimony7:30 Small GroupFor more information, please contact:Kirk McCutcheonkirk.mccutcheon@riverwoodchapel.orgIf you struggle with any of these issues, please know that you are not alone:AnxietyAbandonmentAbuseAngerBetrayal &amp; CodependencyDepressionDrugsDivorceEating DisordersFearFamily ProblemsGriefGamblingGuiltInsecurities over spendingNeed to ControlPeople PleasingPornographyPTSDRelationshipsShameSexual AddictionStressWorkaholism",
    "body_short": null,
    "verbatim": false,
    "content_quality": "raw_form_output",
    "source_kind": "content_collection",
    "metadata": {},
    "handling_notes": "Originally partner-authored verbatim source; demoted to non-verbatim due to content_quality=raw_form_output (reasons: word-boundary mash detected: ['orgIf', 'spendingNeed']; HTML entity leakage; long body with no sentence breaks). Needs human cleanup pass before re-marking verbatim."
  },
  {
    "external_ref_id": "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_2",
    "topic": "care_ministry",
    "label": null,
    "body": "OvercomeThursdays 6:30-8pmRiverwood Chapel Room 115Are you or someone you care about navigating mental health challenges? Join us for an eight-week collective peer group experience of growth and healing. Overcome is a Christ centered community where individuals can find hope, healing, and practical tools for managing their mental health. The group also offers insights and resources to help caregivers and families better understand and support their loved ones in a healthy way.&nbsp;",
    "body_short": null,
    "verbatim": false,
    "content_quality": "raw_form_output",
    "source_kind": "content_collection",
  ...
  {
    "external_ref_id": "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_1",
    "topic": "care_ministry",
    "label": null,
    "body": "Grief ShareThursdays 6:30-8pmRiverwood Chapel in The Gathering SpaceLeader: Diana KnappAre you journeying through a season of grief? You don't have to go through the grieving process alone. GriefShare is a friendly, caring group of people who will walk alongside you through one of life’s most difficult experiences. The $18 fee is for the GriefShare book.Each week stands alone and you can join the group at any time!&nbsp;",
    "body_short": null,
    "verbatim": false,
    "content_quality": "raw_form_output",
    "source_kind": "content_collection",
  ...
  {
    "external_ref_id": "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_4",
    "topic": "care_ministry",
    "label": null,
    "body": "Cancer CareThird Sunday of the month 10:15am Room 114Cancer Care meets to encourage those battling cancer and those who travel the journey with them.",
    "body_short": null,
    "verbatim": true,
  ...
  {
    "external_ref_id": "contentsnare:ministries:care:rfld_RqKznjHbDD83KG:repeater_0",
    "topic": "care_ministry",
    "label": null,
    "body": "Care 101Thursdays 6:30-8pmRiverwood Chapel Room 114Leader: Kirk McCutcheonPlease join us for Care 101 as we weekly address themes related to grief, trauma, broken relationships, anxiety, depression, and much more. More than anything, Care 101 is designed to provide biblical support to those who are walking through hard spaces, no matter what those spaces may be. Join us and find a compassionate community of believers ready to take the next steps together.",
    "body_short": null,
    "verbatim": true,
    "content_quality": "clean",
    "source_kind": "content_collection",

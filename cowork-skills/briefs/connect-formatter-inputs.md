# Formatter Inputs — /connect (Connect)

Riverwood Chapel · Project 3490

After **web-page-copywriter** has produced prose for /connect, invoke `/format-page` and paste this file. The formatter will map the copywriter's structural markers to Brixies `field_values` JSON using these bound template schemas.

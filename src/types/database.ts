...
export interface StrategyAccountProgress {
  ...
  // Web Squad intake flags (v102 / v118). NULL = not yet set; true/false = explicit state.
  web_squad_site_access_provided:      boolean | null
  web_squad_hosting_details_provided:  boolean | null  // v118
  web_squad_domain_registrar_provided: boolean | null  // v118

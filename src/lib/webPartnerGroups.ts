...
export const PARTNER_GROUPS: PartnerGroup[] = [
  {
    ...
    buckets: [
      ...
      { key: 'social_newsletter', label: 'Social Media, Newsletter & Bulletin',
        topics: ['newsletter_bulletin'],
        helpText: 'Newsletter, bulletin. Social handles populate from globals.' },
      { key: 'blog', label: 'Blog',
        topics: ['blog_news'],
        helpText: 'Blog posts, news, and articles from your current site. Only appears when the crawl found content.' },
  ...
  },
  {
    ...
    buckets: [
      ...
      { key: 'careers', label: 'Careers',
        topics: ['careers'],
        helpText: 'Open positions and how to apply.' },

  ...
  return (
    ...
    <div className="lg:grid lg:grid-cols-[260px_minmax(0,1fr)] lg:gap-6 lg:items-start">
      ...
      <div className="space-y-6 min-w-0">
        {/* The "Suggest answers from my uploads" affordance was moved
            internal — strategists run it from the Content Collection
            Responses panel in the WM workspace, not partners on the
            portal. Removed from this page 2026-06-15. */}
        {fromScratch && (
          <ProvideInfoSection
            session={session}
            attachments={attachments}
...
// The AI auto-fill suggester used to live here — moved to
// src/components/wm/workspaces/ContentCollectionAutoFillStaff.tsx
// 2026-06-15 so only internal strategists run it.

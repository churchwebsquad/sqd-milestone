      ...
      grouping_audit: {
        ...
        items: {
          ...
          properties: {
            ...
            inferred_parent_intent: { type: 'string',
            ...
            issue:                  { type: 'string',
              enum: ['mixed_intent','parent_label_mismatch','thin_group','clean'] },
            severity:               { type: 'string', enum: ['high','medium','low'] },
            rationale:              { type: 'string' },
            suggested_fix:          { type: 'string' },
          },
...
export default async function handler(req: any, res: any) {
  ...
  try {
    await setRoadmapStateAtomic(sb, projectId, ['stage_2_5'], { ...toolResult, _meta: meta })
  } catch (e: any) {

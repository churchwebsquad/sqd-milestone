...
const { data: tpl } = await sb.from('web_content_templates').select('*').eq('id','hero-section-34').single()
const html = renderSectionToHtml(tpl as any, {}, {}, {})
writeFileSync('/tmp/hero34.html', html)
